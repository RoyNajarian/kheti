...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (isRegisterMode && password !== confirmPassword) {
      setFeedback({
        type: "error",
        message: t("login.errors.passwords_mismatch"),
      });
      return;
    }
    ...
    try {
      ...
      if (isRegisterMode) {
        ...
        setFeedback({
          type: "success",
          message: t("login.success.account_created"),
        });
        switchMode(false);
        setEmail(email.trim());
        return;
  ...
  return (
    <section
      ...
      aria-label={
        isRegisterMode
          ? t("login.aria.register_page")
          : t("login.aria.login_page")
      }
    >
      <form className="profil__card" onSubmit={handleSubmit}>
        ...
        <label className="profil__label" htmlFor="profil-email">
          {t("login.email_label")}{" "}
          <span className="profil__required">{t("login.required")}</span>
        </label>
        <input
          id="profil-email"
          type="email"
        ...
        <div className="profil__passwordField">
          ...
          <button
            ...
            aria-label={
              showPassword
                ? t("login.aria.hide_password")
                : t("login.aria.show_password")
            }
          ...
          <>
            ...
            <div className="profil__passwordField">
              ...
              <button
                ...
                aria-label={
                  showConfirmPassword
                    ? t("login.aria.hide_confirm_password")
                    : t("login.aria.show_confirm_password")
                }
        ...
        {isRegisterMode ? (
          <p className="profil__switchText">
            <span className="profil__question">
              {t("login.switch_to_login.question")}{" "}
            </span>
            <button
              type="button"
          ...
          <p className="profil__switchText">
            <span className="profil__question">
              {t("login.switch_to_register.question")}{" "}
            </span>
            <button
              type="button"
              className="profil__switchAction"
