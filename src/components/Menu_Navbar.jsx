  ...
  return (
    <nav className="top-nav" aria-label={t("navbar.aria.nav")}>
      ...
      <button
        ...
        aria-label={
          isOpen ? t("navbar.aria.burger_close") : t("navbar.aria.burger_open")
        }
      >
      ...
      >
        ...
        <li>
          <NavLink
            to="/jeu"
            className={({ isActive }) =>
              `nav-button nav-button--labyrinth${isActive ? " nav-button--active" : ""}`
            }
      ...
      <div
        ...
        aria-label={t("navbar.aria.profile_menu")}
      >
        <button
          type="button"
        ...
        >
          <img
            src="/icons/pharaon_icone.png"
            alt=""
            className="nav-profile-link__icon"
          />
        </button>
